...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta http-equiv="Unibenmarket" content="unibenmarket; charset=utf-8">
            ...
            <div class="container"> 
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav" id="main-navbar">
                     ...
                     <li class="nav-item"> <a class="nav-link" id="login_open" href="<?php echo osc_user_login_url(); ?>">
          <?php _e('Login', OSCLASSWIZARDS_THEME_FOLDER) ; ?>
          </a></li>
          
            <li class="nav-item"> <a class="nav-link" href="<?php echo osc_register_account_url() ; ?>">
          <?php _e('Register for a free account', OSCLASSWIZARDS_THEME_FOLDER); ?>
          </a></li>
                      <?php
