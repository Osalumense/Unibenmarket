...
<footer id="footer">
  <div class="container">
    <div class="footer">
      ...
      <?php
            echo '<div class="copyright">' . sprintf(__('Copyright &copy' .date('Y'). ' <a target="_blank" title="osclasswizards" href="#">unibenmarket</a>',OSCLASSWIZARDS_THEME_FOLDER), 'http://www.unibenmarket.com.ng/') . '</div>';
        ?>
    </div>
  </div>
</footer>
